...
Galaxy Tether for Mac은 Galaxy 휴대전화의 모바일 인터넷을 USB로 Mac에서 사용할 수 있게 합니다. RNDIS 연결을 macOS 서비스로 관리하며 USB 테더링을 사용할 수 있을 때 자동으로 다시 연결합니다.
...
- 부팅할 때 서비스가 시작하며 USB 테더링이 켜진 휴대전화를 감지하면 연결합니다.
...
- macOS 26과 One UI 9 조합에서 설치, 자동 서비스 시작, USB HTTPS 접속을 확인했습니다. 다른 하드웨어, 완전한 재부팅, 잠자기 후 복귀는 아직 확인하지 않았습니다.
